...
import { Heart, MapPin, Users, Sprout, ArrowRight, ChevronRight } from 'lucide-react';
    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-charcoal/80 leading-relaxed">
                ...
                <p>
                  In Deutschland angekommen, machte er beim Einkaufen im Supermarkt eine ernüchternde Erfahrung: 
                  <strong className="text-charcoal"> Das, was dort als „Olivenöl" verkauft wird, hat nichts mit dem zu tun, was er von zu Hause kennt.</strong> 
                  Kein echtes kaltgepresstes Öl, keine erste Pressung, keine Qualität, der man vertrauen kann.
                </p>
                <p>
                  Gleichzeitig entdeckte er auf Reisen – besonders in Duty-Free-Zonen – wie viele Menschen 
                  nach echtem, hochwertigem Olivenöl suchen. Und er sah ein zweites Problem:
                </p>

                <div className="my-8 p-8 bg-olive-50 rounded-3xl border border-olive-100">
                  <h4 className="font-serif text-xl text-charcoal mb-4 italic">"Die Bauern haben keinen Zugang zum EU-Markt."</h4>
                  <p className="text-sm text-olive-600">
                    Viele Familienbetriebe im Mittelmeerraum produzieren herausragendes Olivenöl – aber sie haben 
                    weder die Kapazität noch die Kontakte, um es selbst nach Nordeuropa zu exportieren. 
                    Online-Plattformen gibt es zwar, aber die Versandkosten von 10-15€ pro Bestellung machen 
                    den Direktversand für den Kunden unattraktiv.
                  </p>
                </div>

                <p>
                  <strong className="text-charcoal">Beshers Lösung:</strong> Olivenöl in großen Mengen (4.000 Liter) direkt von den Bauern importieren, 
                  in einem eigenen Lager in <strong className="text-charcoal">Frankfurt am Main</strong> lagern und von dort aus in ganz Deutschland versenden. 
                  Das Ergebnis: schnellere Lieferzeiten, günstigere Versandkosten und faire Preise für Bauern <em>und</em> Kunden.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-olive-950 text-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl mb-16 text-center">Die Vision</h2>
          <div className="space-y-16">
            <div className="flex gap-8 items-start">
              <div className="shrink-0 w-20 h-20 bg-olive-600 rounded-2xl flex items-center justify-center text-2xl font-bold">
                '26
              </div>
              <div>
                <h3 className="text-2xl mb-2">Jetzt: Reseller & Erfahrung sammeln</h3>
                <p className="text-olive-300 leading-relaxed">
                  Start mit max. 5 Bauern. Klein anfangen, den Gründer nebenberuflich. 
                  Verkauf der Original-Flaschen der Bauern, um den Markt zu testen und Feedback zu sammeln. 
                  Wochenmärkte mit Proben, Bio-Läden ansprechen.
                </p>
              </div>
            </div>
            <div className="flex gap-8 items-start">
              <div className="shrink-0 w-20 h-20 bg-olive-500 rounded-2xl flex items-center justify-center text-2xl font-bold">
                '29
              </div>
              <div>
                <h3 className="text-2xl mb-2">3 Jahre: Eigene Brand aufbauen</h3>
                <p className="text-olive-300 leading-relaxed">
                  Eigene Marke mit vielen verschiedenen Bauern – ausschließlich Familienbetriebe. 
                  Eine richtige "Bauern-Community" im Mittelmeerraum. Eigene Verpackung (inkl. Nachfülltüten), 
                  eigene Product Journey auf jedem Produkt.
                </p>
              </div>
            </div>
            <div className="flex gap-8 items-start">
              <div className="shrink-0 w-20 h-20 bg-terracotta rounded-2xl flex items-center justify-center text-2xl font-bold">
                '33
              </div>
              <div>
                <h3 className="text-2xl mb-2">5-7 Jahre: Bauern aktiv unterstützen</h3>
                <p className="text-olive-300 leading-relaxed">
                  Das langfristige Ziel: 90% Kooperationsbereitschaft. Die Bauern nicht nur als Lieferanten sehen, 
                  sondern sie aktiv unterstützen – bei der Zertifizierung, beim Export, bei der Vermarktung. 
                  Distribution in ganz Nordwesteuropa.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-terracotta font-bold uppercase tracking-widest text-sm mb-4 block">Unsere Partner</span>
            <h2 className="text-4xl md:text-5xl mb-4">Die Familien hinter dem Öl</h2>
            <p className="text-olive-600 max-w-2xl mx-auto">
              Wir arbeiten ausschließlich mit Familienbetrieben. Keine Großkonzerne, keine anonymen Lieferketten. 
              Wir kennen jeden Bauern persönlich.
            </p>
          </div>
            ...
            {FARMERS.map((farmer, i) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-sm text-olive-700 mb-2"><strong>Spezialität:</strong> {farmer.specialty}</p>

...
import { PRODUCTS, TESTIMONIALS, TEXTS } from '../data';
    ...
    >
      ...
      <section className="bg-harvest-gold text-white py-3 px-6 text-center mt-[72px]">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 flex-wrap">
          <Sparkles size={18} />
          <span className="font-bold text-sm tracking-wide">{TEXTS.home.banner.text}</span>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl mb-6 leading-[1.1]">
              {TEXTS.home.hero.headline}<br />
              <span className="italic text-olive-200">{TEXTS.home.hero.headlineItalic}</span>
            </h1>
            <p className="text-lg md:text-xl mb-8 text-olive-100 max-w-lg">
              {TEXTS.home.hero.subtext}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#shop" className="bg-earth-green hover:bg-earth-green/90 text-white px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 transition-all duration-300 transform hover:-translate-y-1 shadow-md hover:shadow-xl cursor-pointer">
                {TEXTS.home.hero.ctaPrimary} <ArrowRight size={20} />
              </a>
      ...
      <section id="shop" className="py-24 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl mb-4">{TEXTS.home.products.headline}</h2>
            <p className="text-olive-600 max-w-2xl mx-auto">
              {TEXTS.home.products.subtext}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -right-8 bg-white p-8 rounded-3xl shadow-xl max-w-xs hidden md:block">
                  ...
                  <p className="text-sm italic text-olive-800">"{TEXTS.home.subscription.quote}"</p>
                  <p className="text-xs font-bold mt-2">— {TEXTS.home.subscription.quoteAuthor}</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-4xl md:text-5xl mb-6">{TEXTS.home.subscription.headline}</h2>
              <p className="text-lg text-olive-800 mb-8">
                {TEXTS.home.subscription.subtext}
              </p>
              <ul className="space-y-4 mb-10">
                {TEXTS.home.subscription.bullets.map((benefit, i) => (
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input 
                  type="email" 
                  placeholder={TEXTS.home.subscription.emailPlaceholder}
                ...
                <button className="bg-harvest-gold hover:bg-harvest-gold/90 text-white px-8 py-4 rounded-full font-bold transition-all duration-300 shadow-lg shadow-harvest-gold/20 hover:shadow-harvest-gold/40 hover:-translate-y-1 cursor-pointer">
                  {TEXTS.home.subscription.ctaText}
                </button>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-terracotta font-bold uppercase tracking-widest text-sm mb-4 block">{TEXTS.home.storyTeaser.tagline}</span>
              <h2 className="text-4xl md:text-5xl mb-6">{TEXTS.home.storyTeaser.headline}</h2>
              <p className="text-olive-700 mb-6 leading-relaxed">
                {TEXTS.home.storyTeaser.paragraph1}
              </p>
              <p className="text-olive-700 mb-8 leading-relaxed">
                {TEXTS.home.storyTeaser.paragraph2}
              </p>
            ...
            <div className="relative">
              ...
              <motion.img 
                ...
                viewport={{ once: true, margin: "-50px" }}
                transition={{ duration: 1.2, ease: "easeInOut" }}
                src={TEXTS.home.storyTeaser.image}
                alt={TEXTS.home.storyTeaser.headline} 
                loading="lazy"
                width={1000}
                height={667}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative flex justify-center">
              <div className="w-80 h-80 md:w-[500px] md:h-[500px] bg-olive-500/20 rounded-full flex items-center justify-center relative">
                ...
                >
                  <img 
                    src={TEXTS.home.whyUs.productImage}
                    alt="Olivenöl Kanister" 
                    loading="lazy"
                    className="drop-shadow-2xl relative z-0"
                    referrerPolicy="no-referrer"
                  />
                  <Hotspot top={TEXTS.home.whyUs.hotspots[0].top} left={TEXTS.home.whyUs.hotspots[0].left} title={TEXTS.home.whyUs.hotspots[0].title} desc={TEXTS.home.whyUs.hotspots[0].desc} />
                  <Hotspot top={TEXTS.home.whyUs.hotspots[1].top} left={TEXTS.home.whyUs.hotspots[1].left} title={TEXTS.home.whyUs.hotspots[1].title} desc={TEXTS.home.whyUs.hotspots[1].desc} />
                  <Hotspot top={TEXTS.home.whyUs.hotspots[2].top} left={TEXTS.home.whyUs.hotspots[2].left} title={TEXTS.home.whyUs.hotspots[2].title} desc={TEXTS.home.whyUs.hotspots[2].desc} />
                </motion.div>
            ...
            <div>
              <h2 className="text-4xl mb-8">{TEXTS.home.whyUs.headline}</h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl mb-2">{TEXTS.home.whyUs.reasons[0].title}</h4>
                    <p className="text-olive-300 text-sm">{TEXTS.home.whyUs.reasons[0].text}</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="text-xl mb-2">{TEXTS.home.whyUs.reasons[1].title}</h4>
                    <p className="text-olive-300 text-sm">{TEXTS.home.whyUs.reasons[1].text} <Link to="/quality" className="underline text-olive-200 hover:text-white">Ergebnisse einsehen →</Link></p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-xl">
              <h2 className="text-4xl md:text-5xl mb-4">{TEXTS.home.testimonials.headline}</h2>
              <p className="text-olive-600">{TEXTS.home.testimonials.subtext}</p>
            </div>
      ...
      <section className="py-24 bg-olive-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl mb-4 font-serif">{TEXTS.home.faq.headline}</h2>
            <p className="text-olive-600">{TEXTS.home.faq.subtext}</p>
          </div>
          
          <div className="space-y-4">
            {TEXTS.home.faq.items.map((faq, i) => (
